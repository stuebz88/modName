...
public class SimpleCapProvider<HANDLER> implements ICapabilitySerializable<NBTBase>
{
	/**
	 ...
	 */
	public SimpleCapProvider(Capability<HANDLER> capability, @Nullable EnumFacing facing) 
	{
	 ...
	 */
	public SimpleCapProvider(Capability<HANDLER> capability, @Nullable EnumFacing facing, HANDLER instance) {
